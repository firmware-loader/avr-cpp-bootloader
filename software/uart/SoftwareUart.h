...
namespace lib::software {
    ...
    public:
        ...
        constexpr static void init() {
            if constexpr (MCU::family == MCUFamilies::AVR) {
                namespace uartNS = lib::avr::uart;
                using uart = uartNS::UartHal<MCU, 0>;
                uart::template init<baudrate, uartNS::Speed::Double, uartNS::TransmissionMode::FullDuplex, uartNS::StopBits::One, uartNS::DataBits::Eight>();
            }
        }
